...
/**
 * The Class HttpLocationUrlTextValidationRuleTest.
 */
public class HttpLocationUrlTextValidationRuleTest {

	/** The rule. */
	private HttpLocationUrlTextValidationRule rule = null;
	...
	public void testValidateFile() {
		final List<String> messages = rule.validate("file://google.com");
		assertNotNull(messages);
		assertEmpty(messages);
	}
	 ...
	 */
	@Test
	public void testValidateFtp() {
		final List<String> messages = rule.validate("ftp://google.com");
		assertNotNull(messages);
		assertEmpty(messages);
	}
