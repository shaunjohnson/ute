...
/**
 * Unit tests for MavenRepositoryLocationUrlTextValidationRule
 */
public final class MavenRepositoryLocationUrlTextValidationRuleTest {

    /** The rule. */
    private MavenRepositoryLocationUrlTextValidationRule rule = null;
    ...
    @Before
    public void setup() {
        rule = new MavenRepositoryLocationUrlTextValidationRule();
    }
