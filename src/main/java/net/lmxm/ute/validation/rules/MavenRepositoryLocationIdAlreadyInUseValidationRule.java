...
/**
 * The Class MavenRepositoryLocationIdAlreadyInUseValidationRule.
 */
public final class MavenRepositoryLocationIdAlreadyInUseValidationRule extends AbstractStringValidationRule {
	...
	/** The location. */
	private final MavenRepositoryLocation location;

	/**
	 * Instantiates a new Maven repository location id already in use validation rule.
	 *
	 * @param location the location
	 * @param configurationHolder the configuration holder
	 */
	public MavenRepositoryLocationIdAlreadyInUseValidationRule(final MavenRepositoryLocation location,
		...
		errorMessage = ResourcesUtils.getResourceMessage(ValidatorResourceType.MAVEN_REPOSITORY_LOCATION_ID_ALREADY_USED);
	}
	...
	protected List<String> validateString(final String string) {
		...
		if (StringUtils.isNotBlank(string)) {
			...
			final MavenRepositoryLocation existingLocation = ConfigurationUtils.findMavenRepositoryLocationById(configuration, string);
