 ...
 */
public class MavenRepositorySource extends AbstractSource {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -1410426447744470777L;

    /**
     * The remote Maven repository location.
     */
    private MavenRepositoryLocation location;
     ...
     * @return the location
     */
    public MavenRepositoryLocation getLocation() {
        return location;
    }
     ...
     */
    public void setLocation(final MavenRepositoryLocation location) {
