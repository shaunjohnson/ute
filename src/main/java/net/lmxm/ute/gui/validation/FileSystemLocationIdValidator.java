...
/**
 * The Class FileSystemLocationIdValidator.
 */
public final class FileSystemLocationIdValidator extends AbstractIdValidator {

	/** The configuration holder. */
	private final ConfigurationHolder configurationHolder;

	/**
	 * Instantiates a new file system location id validator.
	 * 
	 * @param fileSystemLocation the file system location
	 * @param component the component
	 * @param configurationHolder the configuration holder
	 */
	protected FileSystemLocationIdValidator(final FileSystemLocation fileSystemLocation, final JComponent component,
			final ConfigurationHolder configurationHolder) {
		super(fileSystemLocation, component);
	...
	protected IdentifiableBean getExistingObject(final String id) {
		return ConfigurationUtils.findFileSystemLocationById(configurationHolder.getConfiguration(), id);
	}
	...
	protected String getObjectInUseMessage() {
		return ResourcesUtils.getResourceMessage(ValidatorResourceType.FILE_SYSTEM_LOCATION_ID_ALREADY_USED);
	}
	...
	protected String getObjectRequiredMessage() {
		return ResourcesUtils.getResourceMessage(ValidatorResourceType.FILE_SYSTEM_LOCATION_ID_REQUIRED);
	}
}
