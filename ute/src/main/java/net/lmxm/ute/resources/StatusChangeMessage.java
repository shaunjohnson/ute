...
public enum StatusChangeMessage implements ResourceType {
	...
	/** The FILE_DELETE_ERROR. */
	FILE_DELETE_ERROR,

	/** The FILE_ELETE_FILE_DELETE_FINISHED. */
	FILE_DELETE_FILE_DELETE_FINISHED,

	/** FILE_DELETE_FILE_DELETE_STARTED. */
	FILE_DELETE_FILE_DELETE_STARTED,

	/** The FILE_DELETE_FILE_DOES_NOT_EXIST_ERROR. */
	...
	/** The SUBVERSION_AUTHENCITAION_FAILED. */
	SUBVERSION_AUTHENCITAION_FAILED,

	/** The SUBVERSION_EXPORT_DIRECTORY_ADDED. */
	SUBVERSION_EXPORT_DIRECTORY_ADDED,

	/** The SUBVERSION_EXPORT_ERROR. */
	SUBVERSION_EXPORT_ERROR,

	/** The SUBVERSION_EXPORT_FILE. */
	SUBVERSION_EXPORT_FILE,

	/** The SUBVERSION_EXPORT_FILE_ADDED. */
	SUBVERSION_EXPORT_FILE_ADDED,

	/** The SUBVERSION_EXPORT_FILE_ADDED_AS. */
	SUBVERSION_EXPORT_FILE_ADDED_AS,

	/** The SUBVERSION_EXPORT_FINISHED. */
	SUBVERSION_EXPORT_FINISHED,

	/** The SUBVERSION_EXPORT_REPORT_ERROR. */
	SUBVERSION_EXPORT_REPORT_ERROR,

	/** The SUBVERSION_EXPORT_STARTED. */
	SUBVERSION_EXPORT_STARTED,

	/** The SUBVERSION_UPDATE_ERROR. */
	SUBVERSION_UPDATE_ERROR,

	/** The SUBVERSION_UPDATE_EVENT_ADD. */
	SUBVERSION_UPDATE_EVENT_ADD,

	/** The SUBVERSION_UPDATE_EVENT_DELETE. */
	SUBVERSION_UPDATE_EVENT_DELETE,

	/** The SUBVERSION_UPDATE_EVENT_FAILED_EXTERNAL. */
	SUBVERSION_UPDATE_EVENT_FAILED_EXTERNAL,

	/** The SUBVERSION_UPDATE_EVENT_LOCK_FAILED. */
	SUBVERSION_UPDATE_EVENT_LOCK_FAILED,

	/** The SUBVERSION_UPDATE_EVENT_LOCKED. */
	SUBVERSION_UPDATE_EVENT_LOCKED,

	/** SUBVERSION_UPDATE_EVENT_UPDATE. */
	SUBVERSION_UPDATE_EVENT_UPDATE,

	/** The SUBVERSION_UPDATE_EVENT_UPDATE_COMPLETED. */
	SUBVERSION_UPDATE_EVENT_UPDATE_COMPLETED,

	/** The SUBVERSION_UPDATE_EVENT_UPDATE_EXTERNAL. */
	SUBVERSION_UPDATE_EVENT_UPDATE_EXTERNAL,

	/** The SUBVERSION_UPDATE_EVENT_UPDATE_NONE. */
	SUBVERSION_UPDATE_EVENT_UPDATE_NONE,

	/** The SUBVERSION_UPDATE_FINISHED. */
